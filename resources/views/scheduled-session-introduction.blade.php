	...
	<div class="container">
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-9 mb-4">
				<h1 class="text-center">Si llegas 1 segundo tarde a tu Introducción tendrás que reagendar</h1>
			</div>
            <div class="col-12">
                <p class="text-center">
                    Te enviamos un correo con la liga para que acceses a tu Introducción. También podrás accesar desde tu perfil.<br>
                    Al hacer click en el botón de Google Calendar crearás un nuevo evento en tu calendario.<br>
                    Te enviaremos un segundo correo 6 minutos antes de iniciar tu Introducción.
                </p>
            </div>
            <div class="col-lg-6 text-center scheduled-session-box bg-white">
                <img src="{{ url('img/google_calendar.png') }}" alt="" class="img-fluid">
                <a href="" target="_blank" class="btn btn-dark button-b"><span style="color: #fff;" class="">Entra</span> a tu sesión de Introducción <i class="ml-4 fa-solid fa-arrow-up"></i></a>
            </div>
			 <div class="col-12">
                <p class="text-center mb-0">Tu Introducción comenzará en</p>
