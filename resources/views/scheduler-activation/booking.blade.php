	...
	<div class="container">
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-9 mb-4">
				<h1 class="text-center">Luz armónica saldrá de tus manos</h1>
			</div>
            <div class="col-lg-9">
                <p class="text-center">
                   Tu Activación durará 1 hora (30 minutos acostado y 30 minutos de práctica). Tenemos registrada tu hora local como Lunes a las 8:30am CDT. Toda sesión se encuentra en tu horario local.
                </p>
            </div>
            <div class="col-12">
